...
class ComicSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $comics =  [
            [
                "tile" => "Action Comics #1000: The Deluxe Edition",
            ...
            [
                "tile" => "Batman: The Joker War Zone #1",
            ...
            [
                "tile" => "Batman: White Knight Presents: Harley Quinn #1",
